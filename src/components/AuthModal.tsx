            ...
            <>
              ...
              <div className="relative my-6">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-4 bg-white text-emerald-500 font-medium">or continue with</span>
                </div>
              </div>
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-emerald-400 rounded-xl hover:bg-emerald-50 transition-colors"
              >
                ...
                <span className="text-emerald-600 font-medium text-sm">Continue with Google</span>
              </button>
